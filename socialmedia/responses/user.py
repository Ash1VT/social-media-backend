...
from .body import get_user_response_body, get_current_user_response_body, \
    ...
    get_user_unauthenticated_response_body, \
    get_user_requesting_foreign_user_id_response_body, get_all_users_response_body
...
__all__ = ['get_user_response', 'get_all_users_response', 'get_current_user_response',
           ...
           'get_user_unauthenticated_response',
           'get_user_requesting_foreign_user_id_response']


def get_user_response(user: UserDto) -> Tuple[Response, int]:
    return jsonify(get_user_response_body(user=user)), 200


def get_all_users_response(users: List[UserDto]) -> Tuple[Response, int]:
    return jsonify(get_all_users_response_body(users=users)), 200


def get_current_user_response(user: UserDto) -> Tuple[Response, int]:
...
def get_user_requesting_foreign_user_id_response() -> Tuple[Response, int]:
    return jsonify(get_user_requesting_foreign_user_id_response_body()), 403
